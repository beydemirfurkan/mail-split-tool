...
function ExcelMerger() {
  ...
  const handleMergeFiles = async () => {
    ...
    for (const file of files) {
      ...
      // Birleştirilmiş veri listesine ekle
      combinedData.push(...json);
    }

    // Yeni bir çalışma kitabı oluştur ve verileri ekle
    ...
    // Yeni çalışma kitabını bir blob olarak kaydet ve indir
